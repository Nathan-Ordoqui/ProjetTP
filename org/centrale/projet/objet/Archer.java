...
public class Archer extends Personnage{
    ...
    /**
     * Construit un archer depuis une ligne de sauvegarde
     * @param ligne
     */
    ...
    /**
     * Construit un archer avec arguments
     * @param nom Nom
     * @param ptV
     * @param ptM
     * @param pA Pourcentage d'attaque
     * @param pP Points de Parades
     ...
     */
    public Archer(String nom, int ptV,int ptM, int pA, int pP,int pcP, int pM, int rM, int dA, int dM, int distMax, Point2D pos, int nbF){
       this.nom = nom; 
       this.ptVie = ptV; 
       this.ptMana = ptM;
    ...
    /**
     * Construit un archer par défaut
     */
    public Archer(){
        this.nom = "Archer"; 
        this.ptVie = 40+RandomInteger.main(30);
    ...
    /**
     * Crée une copie d'archer
     * @param a archer à copier
     */
    public Archer(Archer a){
       this.nom = a.getNom(); 
       this.ptVie = a.getPtVie(); 
       this.ptMana = a.getPtMana();
       this.pourcentageAtt = a.getPourcentageAtt();
       
       this.pourcentagePar = a.getPourcentagePar();
       this.pourcentageMag = a.getPourcentageMag();
       this.pourcentageResistMag = a.getPourcentageResistMag();
       
       this.degAtt = a.getDegAtt();
       this.degMag = a.getDegMag();
       this.distAttMax = a.getDistAttMax();
       
       
       this.pos = new Point2D(a.getPos());
    ...
    /**
     * Modifie nombre de flèches
     * @param value nombre de flèches à donner
     */
    ...
    /**
     * Combat une créature
     * @param c créature en entrée
     */
    public void combattre(Creature c){
        if((this.nbFleches>0)&&(this.getPos().distance(c.getPos())<this.distAttMax)&&(this.getPos().distance(c.getPos())>=1)){
            this.nbFleches -= 1;
            int r = Rand.main(100);
    ...
    @Override
    public void affiche(){
        System.out.println("Archer : nom : "+this.nom+"\n    points de vie : "+this.ptVie+
                ...
                "\n    nombre de flèches : "+this.nbFleches+"\n    position : "+this.pos.toString());
    }
    
    /**
     * Génère la ligne de sauvegarde de l'Archer
     * @return
     */
    public String getTexteSauvegarde(){
        ...
        String texte = this.getSClass()+" "+this.nom
                ...
                " "+this.degAtt+" "+this.degMag+" "+this.distAttMax
                +" "+this.ptPar+" "+this.nbFleches
                +" "+x+" "+y;
        return texte;
    }
